...
class PacmanSprites(Spritesheet):
    ...
    def defineAnimations(self):
        self.animations[LEFT] = Animator(((6,2), (10, 2), (8, 2), (10, 2)))
        self.animations[RIGHT] = Animator(((6,0), (8, 0), (10, 0), (8, 0)))
        self.animations[UP] = Animator(((0,0), (2, 0), (4, 0), (2, 0)))
        self.animations[DOWN] = Animator(((0,2), (4, 2), (2, 2), (4, 2)))
...
class GhostSprites(Spritesheet):
    def __init__(self, entity):
        Spritesheet.__init__(self)
        self.x = {BLINKY:8, PINKY:4, INKY:6, CLYDE:2}
        self.entity = entity
        self.entity.image = self.getStartImage()
    ...
    def update(self, dt):
        ...
        if self.entity.mode.current in [SCATTER, CHASE]:
            ...
            if self.entity.direction == LEFT:
                self.entity.image = self.getImage(0, 8)
            elif self.entity.direction == RIGHT:
                self.entity.image = self.getImage(0, 10)
            elif self.entity.direction == DOWN:
                self.entity.image = self.getImage(0, 6)
            elif self.entity.direction == UP:
...
class LifeSprites(Spritesheet):
    ...
    def resetLives(self, numlives):
        ...
        for i in range(numlives):
            self.images.append(self.getImage(8,0))
