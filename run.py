...
class GameController(object):
    def __init__(self):
        ...
        self.clock = pygame.time.Clock()# Clock makes the game runs at same speed on all computers
        self.fruit = None
    ...
    def update(self):
        dt = self.clock.tick(30) / 1000.0 # shange in time used to claculate distance
